        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-[var(--color-paper-raised)] border border-[var(--color-hairline)] rounded-lg p-4">
            ...
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie data={breakdown} dataKey="amount" nameKey="category" innerRadius={50} outerRadius={80}>
          ...
          <div className="bg-[var(--color-paper-raised)] border border-[var(--color-hairline)] rounded-lg p-4">
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={accounts.map((a) => ({ name: a.name, balance: (accountBalances.get(a.id) ?? 0) / 100 }))}>
